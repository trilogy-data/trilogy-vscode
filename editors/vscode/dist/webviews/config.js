...
// src/webViews/config/config.tsx
var import_react = __toESM(require_react());
var import_client = __toESM(require_client());
function App() {
  return /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, /* @__PURE__ */ import_react.default.createElement("header", null, /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("div", { className: "mb-4 border-editor-border border-l-4 border-0 bg-editor rounded-lg  pl-4" }, /* @__PURE__ */ import_react.default.createElement("h1", { className: "font-medium mb-1" }, "Current Datasource"), /* @__PURE__ */ import_react.default.createElement("div", { className: "flex flex-col gap-4" }, /* @__PURE__ */ import_react.default.createElement("p", { className: "text-sm text-muted-foreground" }, "Start using Trilogy by using the default DuckDB connection or setting a different connection below."), /* @__PURE__ */ import_react.default.createElement(
    "a",
    {
    ...
    "Add a Connection"
  ))), /* @__PURE__ */ import_react.default.createElement("div", { className: "mb-4 border-editor-border border-l-4 border-0 bg-editor rounded-l pl-4" }, /* @__PURE__ */ import_react.default.createElement("h1", { className: "font-medium mb-2" }, "Model Status"), /* @__PURE__ */ import_react.default.createElement("div", { className: "flex flex-col gap-3" }, /* @__PURE__ */ import_react.default.createElement("p", { className: "text-sm text-muted-foreground" }, "Information on your parsed model will be displayed here."))))), /* @__PURE__ */ import_react.default.createElement("main", null, /* @__PURE__ */ import_react.default.createElement("nav", { className: "space-y-8" }, /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("h2", { className: "mb-2 tracking-widest uppercase text-xs text-muted-foreground" }, "Configure GenAI"), /* @__PURE__ */ import_react.default.createElement(
    "a",
    {
      href: "command:trilogy.setOpenAIApiKey",
      className: "flex gap-2 items-center"
    },
    /* @__PURE__ */ import_react.default.createElement("i", { className: "pdicon pdicon-openai text-sm inline-flex" }),
    /* @__PURE__ */ import_react.default.createElement("div", null, "OpenAI ")
  )))));
}
(function() {
