...
// src/webViews/query/queryPanelContent.tsx
var import_client = __toESM(require_client());
var import_react = __toESM(require_react());
var ITEMS_PER_PAGE = 20;
var QueryResults = class extends import_react.Component {
  constructor(props) {
    super(props);
    this.state = {
      currentPage: 1
  ...
  render() {
    ...
    return /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, /* @__PURE__ */ import_react.default.createElement("main", null, /* @__PURE__ */ import_react.default.createElement("table", { className: "table-auto" }, /* @__PURE__ */ import_react.default.createElement("thead", null, /* @__PURE__ */ import_react.default.createElement("tr", null, headers.map((field, index) => /* @__PURE__ */ import_react.default.createElement("th", { key: index }, field.column_name)))), /* @__PURE__ */ import_react.default.createElement("tbody", null, data.map((rowData, index) => /* @__PURE__ */ import_react.default.createElement("tr", { key: index }, headers.map((field, idx) => /* @__PURE__ */ import_react.default.createElement("td", { key: idx }, rowData[field.column_name]))))))));
  }
};
function SubmitButton({ vscode }) {
  ...
  return /* @__PURE__ */ import_react.default.createElement("button", { type: "submit", onClick: handleSubmit }, "Submit");
}
var QueryWrapper = class extends import_react.Component {
  constructor(props) {
    super(props);
    this.handleNextPage = () => {
  ...
  render() {
    ...
    return /* @__PURE__ */ import_react.default.createElement("div", { className: "w-full min-h-screen  flex flex-col items-center" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "w-full max-w-4xl p-6  shadow-md rounded-lg" }, /* @__PURE__ */ import_react.default.createElement(
      "input",
      {
        nonce: "${nonce}",
        type: "text",
    ...
    ), /* @__PURE__ */ import_react.default.createElement("form", { className: "flex flex-col items-start mb-4" }, /* @__PURE__ */ import_react.default.createElement(
      SubmitButton,
      {
        vscode
      }
    )), /* @__PURE__ */ import_react.default.createElement("h2", { className: "text-l font-semibold mb-2 text-white-700" }, "Response (", data.length, " rows)"), /* @__PURE__ */ import_react.default.createElement(QueryResults, { data: currentData, headers })), /* @__PURE__ */ import_react.default.createElement("div", { className: "flex justify-between items-center mt-6" }, /* @__PURE__ */ import_react.default.createElement(
      "button",
      {
      ...
      "Previous"
    ), /* @__PURE__ */ import_react.default.createElement("span", { className: "text-white-500 py-4" }, "Page ", currentPage), /* @__PURE__ */ import_react.default.createElement(
      "button",
      {
...
var queryWrapperRef = (0, import_react.createRef)();
(function() {
  const root = import_client.default.createRoot(document.getElementById("root"));
  const vscode = acquireVsCodeApi();
  root.render(/* @__PURE__ */ import_react.default.createElement(QueryWrapper, { ref: queryWrapperRef, vscode }));
  function initialize() {
  }
